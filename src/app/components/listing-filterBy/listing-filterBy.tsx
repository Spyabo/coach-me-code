...
export default function ListingFilterBy({
  listingArray,
  sort_by,
}: {
  listingArray: getListingsResponse[];
  sort_by: keyof getListingsResponse;
}) {
  const values: (string | number)[] = listingArray
    .map((listingObj) => listingObj[sort_by])
    .flat();
